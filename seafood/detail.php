<?php 
    ...
    $total_points = get_total_points("seafood",$id); // get total points for rating
    $record = get_detail_record("seafood",$id); // get detail record
                ...
                <div class="row">
                    <div style="padding:0" class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <p style="margin-top: 10px;">
                            <?php
                                $calculated_points = calculate_ratings($id,"seafood");
